...
def build_app():
    ...
    def build_app_osx():
        ...
        subprocess.call(["mkdir", "dist/trustnoone.app/Contents/PlugIns"])
        subprocess.call(["cp", "-r", "gui/file_sync_status/osx/build/Release/FileSyncClient.appex", "dist/trustnoone.app/Contents/PlugIns/"])
